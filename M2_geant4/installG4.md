...
```bash
cmake -DCMAKE_INSTALL_PREFIX=/path/to/geant4-v11.4.1-install /path/to/geant4-v11.4.1 -DGEANT4_INSTALL_DATA=ON -DGEANT4_BUILD_MULTITHREADED=ON -DGEANT4_USE_OPENGL_X11=ON -DGEANT4_USE_QT=ON
```
